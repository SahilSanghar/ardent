...
const testimonials = [
  {
    text: `Ardent Co. brought clarity to a complex regulatory landscape and helped us understand not just what was changing, but what it meant for our business. Their ability to connect policy developments with business priorities was particularly valuable.`,
    role: "Head of Corporate Affairs",
    company: "Leading Infrastructure Company",
  },
  {
    text: `The team demonstrated a strong understanding of the regulatory environment and translated complex developments into clear, actionable insights. Their approach helped us engage with policy issues with greater structure and confidence.`,
    role: "Director – Public Affairs",
    company: "Leading Financial Services Company",
  },
  {
    text: `Ardent Co. helped us navigate an evolving policy environment with a structured approach to stakeholder engagement, policy communication and regulatory tracking. Their insights enabled us to respond proactively rather than reactively.`,
    role: "Vice President – Government Affairs",
    company: "Global Technology Company",
  },
  {
    text: `What stood out was their ability to understand the intersection of policy, regulation and business realities. They brought together research, stakeholder intelligence and strategic counsel in a way that supported our larger business objectives.`,
    role: "Chief Corporate Affairs Officer",
    company: "Leading Manufacturing Group",
  },
];

export default function PublicPolicyHeroWithForm() {
...
useEffect(() => {
  ...
  const handleClientSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      await axios.post("/api/ardentco-public-policy-submit", {
      ...
      router.replace("/ardentco-public-policy/success");
    } catch (err) {
        ...
        <div className="relative flex items-center p-14 md:p-16 overflow-hidden w-full md:w-1/2 min-h-[60vh] md:min-h-screen">
          ...
          <div className="relative z-10 max-w-xl">
            <h1 className={`${playfair.className} text-5xl lg:text-6xl leading-tight text-black`}>
              ...
              The <span className="text-blue-800 font-black">Right Policy</span>
            </h1>

            <p className="mt-6 mb-8 text-gray-700 text-lg leading-relaxed">
              Our Public Policy &amp; Regulatory Affairs practice helps businesses navigate complex policy and regulatory environments, anticipate change, engage the right stakeholders and turn policy challenges into strategic opportunities.
            </p>
          ...
          <div className="flex flex-col gap-10">
            ...
            <div>
              ...
              <p className="mt-2 text-2xl text-white leading-snug">
                policy &amp; regulatory <br/> service areas
              </p>
            </div>
            ...
            <p className={`${playfair.className} text-xl lg:text-2xl text-white font-bold leading-snug`}>
              across businesses, regulators, <br/>institutions &amp; policymakers
            </p>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <div className="p-8 rounded-2xl bg-blue-100">
        ...
        <p className="text-base text-gray-700 leading-relaxed">
          We translate complex policy issues into clear, credible communication for policymakers, stakeholders, industry and the public.
        </p>
      </div>
      ...
      <div className="p-8 rounded-2xl bg-blue-800 text-white">
        ...
        <p className="text-base leading-relaxed">
          We help organisations navigate parliamentary processes &amp; engage effectively with parliamentarians, committees and legislative developments.
        </p>
      </div>
      ...
      <div className="p-8 rounded-2xl border-2 border-black">
        <h3 className={`${playfair.className} text-xl font-bold mb-3`}>
          Advocacy &amp; <br />Legislative Campaigns
        </h3>
        <p className="text-base text-gray-700 leading-relaxed">
          We build evidence-led advocacy strategies, from defining legislative priorities and stakeholder mapping to policy positions and campaign execution.
        </p>
      </div>
      ...
      <div className="p-8 rounded-2xl border-2 border-blue-200">
        ...
        <p className="text-base text-gray-700 leading-relaxed">
          We help organisations navigate regulatory requirements through tailored compliance frameworks, SOPs and practical regulatory guidance.
        </p>
      </div>
      ...
      <div className="p-8 rounded-2xl border-2 border-blue-800">
        ...
        <p className="text-base text-gray-700 leading-relaxed">
          We monitor policy, regulatory and legislative developments to identify emerging risks, opportunities and shifts that may impact business.
        </p>
      </div>
      ...
      <div className="p-8 rounded-2xl bg-blue-100">
        ...
        <p className="text-base text-gray-700 leading-relaxed">
          We assess how existing and emerging policies affect business and identify opportunities where policy can support growth, resilience and long-term value.
        </p>
      </div>
  ...
  <div className="max-w-6xl mx-auto px-6 md:px-10 py-16 md:py-20 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-10">
    ...
    <div>
      <h2 className={`${playfair.className} text-5xl lg:text-6xl leading-tight text-black max-w-xl`}>
        Policy Expertise <br />That <span className="text-blue-800 font-black">Gets Heard</span>
      </h2>
